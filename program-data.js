    ...
    },
    {
      ...
      "events": [
        ...
        },
        {
          ...
          "abstract": "Summary:\nRecent years have seen increasing scholarly attention to AI-based automatic assessment of translation and interpreting (T&I), with work spanning approaches from machine-learning score prediction to large language model (LLM)-enabled end-to-end evaluation.\nThis symposium examines how AI can be leveraged to assess T&I across diverse contexts, tasks, and levels of stakes. JIANG Xinlei will propose a fine-grained, linguistically grounded framework to evaluate machine interpreting. LU Xiaolei will share findings from a study on multimodal LLM scoring of handwritten translations and the role of prompt configuration. WANG Weiwei will introduce Interpret-AI, an AI interpreting scoring system that operationalizes the China Standards of English (CSE) interpreting scale for pedagogical and testing use. Finally, JIANG Zhaokun will discuss fine-tuning two pre-trained language models for automatic interpreting scoring and the implications for construct- and direction-sensitive assessment.\nCollectively, the symposium synthesizes recent empirical advances and offers actionable insights for trustworthy AI-supported T&I assessment.\n\nIntroduction: Chao Han [6 min]\n\nPresentation 1: A/P Jiang Xinlei, Xi’an Jiaotong University [15 min]\n- Title: Assessing AI-powered simultaneous interpreting in China: Using automated evaluation metrics and multi-dimensional quantitative linguistic indices\n- Abstract: Although AI-powered translation has reached near-human performance in many text-based tasks, AI-powered simultaneous interpreting (SI) still faces challenges such as error propagation and latency, and its performance is often overestimated due to limited evaluation standards. This study proposes a fine-grained, linguistically grounded framework to assess two leading Chinese AI-powered SI systems in Chinese-English conference interpreting. Fidelity is evaluated using automated metrics with reference to human expert SI, while acceptability is assessed through multi-dimensional quantitative linguistic indices. The findings aim to inform more rigorous evaluation standards for emerging AI-powered SI technologies.\n\nPresentation 2: A/P Lu Xiaolei, Xiamen University [15 min]\n- Title: Going multimodal: Leveraging multimodal large language models to evaluate students’ handwritten translations in language proficiency testing\n- Abstract: Handwritten translation tasks in large-scale language tests in China are costly to score. Using 60 handwritten translations from College English Test Band 4, we evaluated whether eight multimodal LLMs (MLLMs) can provide reliable automated scores and which configurations work best. We tested model characteristics (origin, accessibility), prompt language (English vs. Chinese), and prompting techniques (self-explanation, chain-of-thought, and in-context learning), and assessed performance via scoring consistency, consensus, and deviation from human scores. Results showed that model origin/accessibility significantly affected accuracy. Performance improved when models scored image-to-text transcripts and used text-based exemplars for in-context learning. GPT-4o and Seed1.5-VL achieved the strongest overall results. These findings are expected to inform practical optimization for automated scoring.\n\nPresentation 3: Prof. Wang Weiwei, Guangdong University of Foreign Studies [15 min]\n- Title: Empowering interpreter training and assessment through AI: The development and application of Interpret-AI\n- Abstract: Assessing interpreting competence involves complex variables that often lead to inter-rater reliability issues. This session introduces Interpret-AI, a system that incorporates an automated assessment algorithm to provide objective evaluations of human interpreting. The platform’s underlying algorithms analyze performance data to deliver diagnostics regarding content, delivery and communicative effects. By integrating these automated metrics into a structured instructional framework, Interpret-AI facilitates a systematic",
          "authors": [
            {
              "name": "Chao Han",
              "affiliation": "National University of Singapore",
