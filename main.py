        ...
        'sections': [
            {
                'id': 'aala2026-intro',
                'heading': 'AALA 2026',
                'content': "The Asian Association for Language Assessment (AALA) 2026 Conference will be held from September 18-20, 2026, at the City University of Macau. This year's theme is the 'Humanistic approach to Assessment, Standards, Innovation, and Accountability'. We invite you to contribute to this important conversation. You can find more information on our <a href='call-for-papers.html'>Call for Papers</a> page."
            },
            {
                'id': 'about-aala',
        ...
        'sections': [
            {
                ...
                <ul>
                    ...
                    <li><b>Colloquia:</b> (90 minutes, 3–4 coordinated papers with discussion)</li>
                    <li><b>Posters:</b> (interactive sessions)</li>
                    <li><b>Workshops:</b> (90 minutes, hands-on training)</li>
                </ul>
                <br>
                <h3>Key Dates</h3>
                <ul>
                ...
                <br>
                <p>🔗 <a href="https://forms.office.com/r/bSxtmKfi8C?origin=lprLink" target="_blank">Submit your abstract and register via the official conference website.</a></p>
...
<body>
    <header class="navbar">
        <div class="logo-container">
            <img src="AALA2026 logo.png" alt="AALA 2026 Logo" class="logo-image">
        </div>
        <nav class="nav-links">
